...
bool Services::ajouter()
{
    ...
    query.prepare("INSERT INTO Services (ID_Service, Nom_Service, Type_Service, Date_Service, Etat) "
                  "VALUES (:ID_Service, :Nom_Service, :Type_Service, TO_DATE(:Date_Service, 'YYYY-MM-DD'), :Etat)");
...
{
    QSqlQuery query;
    query.prepare("UPDATE Services SET Nom_Service = :Nom_Service, Type_Service = :Type_Service, Date_Service = TO_DATE(:Date_Service, 'YYYY-MM-DD'), "
                  "Etat = :Etat "
