...
MagasinMainWindow::MagasinMainWindow(QWidget *parent)
    ...
    connect(ui->employes, &QPushButton::clicked, this, &MagasinMainWindow::on_btnEmployees_clicked);
    connect(ui->sponsors, &QPushButton::clicked, this, &MagasinMainWindow::on_btnSponsors_clicked);
...
void MagasinMainWindow::on_btnEmployees_clicked() {
    Employe emp;
...
void MagasinMainWindow::on_btnSponsors_clicked() {
    Employe emp;
...
void MagasinMainWindow::on_btnServices_clicked() {
    Employe emp;
...
void MagasinMainWindow::on_btnEvents_clicked() {
    Employe emp;
...
void MagasinMainWindow::on_btnSuppliers_clicked() {
    Employe emp;
