    ...
    , ui(new Ui::EmployeesMainWindow)
{
    ...
    connect(ui->sponsors, &QPushButton::clicked, this, &EmployeesMainWindow::on_btnSponsors_clicked);
    connect(ui->services, &QPushButton::clicked, this, &EmployeesMainWindow::on_btnServices_clicked);
    connect(ui->evenement, &QPushButton::clicked, this, &EmployeesMainWindow::on_btnEvents_clicked);
    connect(ui->fournisseurs, &QPushButton::clicked, this, &EmployeesMainWindow::on_btnSuppliers_clicked);
    connect(ui->magasins, &QPushButton::clicked, this, &EmployeesMainWindow::on_btnStores_clicked);
